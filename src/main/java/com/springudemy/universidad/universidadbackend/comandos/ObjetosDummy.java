...
public class ObjetosDummy {
    ...
    public static Carrera getCarreraIngMec(){
        return new Carrera(null, "Ingenieria Mecanica", 80, 7);
    }

    public static Carrera getCarreraLicEco(){
        return new Carrera(null, "Licenciatura en Economia", 42, 5);
    }
