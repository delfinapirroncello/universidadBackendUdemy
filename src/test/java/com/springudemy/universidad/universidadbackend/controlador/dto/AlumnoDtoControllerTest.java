...
import com.springudemy.universidad.universidadbackend.controlador.AlumnoController;
...
@WebMvcTest(AlumnoDtoControllerTest.class)
...
/*
    ...
    void obtenerAlumnoPorId() throws Exception {
        //GIVEN
        AlumnoController dto = new AlumnoController(
                null,
